...
import { rentForMonth } from "../crosby-rent-engine.js";
...
// Projected base rent for one lease in a given month. Delegates to the shared
// crosby-rent-engine so the assistant, the dashboard rent roll, and the Excel
// export all return identical figures. `m` is 0-based (0 = January).
function monthRentFor(l, Y, m, today) {
  return rentForMonth(l, Y, m, today);
}
