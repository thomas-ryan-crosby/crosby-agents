...
function monthRentFor(l, Y, m, today) {
  ...
  // Governing rate: a prior rent segment (e.g. before a premises/rent reduction)
  // governs months before its successor takes effect; use that rate flat.
  if (l.rentSchedule && l.rentSchedule.length) {
    ...
    if (gov && gov !== cur) return Number(gov.monthlyRent) || 0;
  }
